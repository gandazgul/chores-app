...
The project is built using AstroJS and Deno. It uses Google Sign-In for authentication (not yet implemented) and a local SQLite database managed by Knex for data storage.
