 ...
 *
 * @param rruleString The RRULE string (e.g., "FREQ=DAILY", "FREQ=WEEKLY;BYDAY=MO,WE,FR")
 * @param lastCompletedDate The date the chore was last completed.
 * @returns A Date object representing the next occurrence, or null if the rrule is invalid or has ended.
 */
export function calculateNextOccurrence(
  ...
  try {
    ...
    const nextDate = rule.after(startDate, false); // false means strictly after
